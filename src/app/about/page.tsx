      ...
      <main className="mx-auto max-w-3xl px-4 pt-24 pb-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 space-y-6 text-[var(--foreground)]/90">
          <section className="space-y-2">
            ...
            <p>
              We organize order signals from the inbox connection you choose (Gmail App Password) to highlight where you
              may be owed money. We then generate clear, audit-friendly

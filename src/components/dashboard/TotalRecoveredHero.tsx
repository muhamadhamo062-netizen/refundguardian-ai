  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-emerald-500/25 bg-gradient-to-br from-emerald-950/40 via-[var(--card)] to-[#0a0c10] p-6 shadow-2xl shadow-black/30 sm:p-7">
      ...
      <div className="relative">
        <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-emerald-200/70 sm:text-xs md:text-sm">
          Total recovered
        </p>
        ...
        <p className="mt-3 text-xs text-zinc-500 sm:text-sm">{subtitle}</p>
        {totalDollars <= 0 ? (
          <p className="mt-1.5 text-[11px] text-zinc-500/80">Waiting for your first scan...</p>
        ) : null}
      </div>
    </div>
  );

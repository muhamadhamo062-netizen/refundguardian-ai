      ...
      <div className="relative">
        ...
        <div className="mt-8 overflow-hidden rounded-2xl border border-white/10 bg-black/20">
          <div className="w-full">
            <table className="w-full table-fixed text-[11px] leading-snug sm:text-sm">
              <thead>
                <tr className="border-b border-white/10 bg-white/[0.03]">
                  <th className="w-1/2 px-3 py-3 text-left text-[10px] font-semibold uppercase tracking-wider text-zinc-400 sm:px-5 sm:py-4 sm:text-xs">
                    The Old, Boring Way
                  </th>
                  <th className="relative w-1/2 border-l border-emerald-500/30 bg-gradient-to-br from-emerald-500/15 via-emerald-500/5 to-transparent px-3 py-3 text-left text-[10px] font-semibold uppercase tracking-wider text-emerald-200 shadow-[inset_0_0_24px_rgba(16,185,129,0.12)] sm:px-5 sm:py-4 sm:text-xs">
